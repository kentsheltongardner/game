...
export default class Images {
    ...
    public static readonly OffsetIconMoth               = 95
    public static readonly OffsetIconLadybug            = 96
    public static readonly OffsetIconWorker             = 97
    public static readonly OffsetIconQueen              = 98
    public static readonly OffsetIconBeehive            = 99
    public static readonly OffsetIconDragonfly          = 100
    public static readonly OffsetIconPlaque             = 108
    public static readonly OffsetIconPlaqueTranslate    = 109
    public static readonly OffsetIconPlaqueReflect      = 141
    public static readonly OffsetIconPlaqueRotate       = 145
    ...
    public static readonly OffsetTemplateGrass          = 6
    public static readonly OffsetTemplateWood           = 7
    public static readonly OffsetTemplateStone          = 8
    public static readonly OffsetTemplateWater          = 9
    public static readonly OffsetTemplateCloud          = 10
    public static readonly OffsetTemplateFront          = 11
    public static readonly OffsetTemplateBack           = 12
    public static readonly OffsetTemplateTile           = 13
    public static readonly OffsetTemplateBasePlain      = 14
    public static readonly OffsetTemplateCrease         = 15
