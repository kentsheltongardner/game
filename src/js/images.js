...
export default class Images {
    ...
    static OffsetIconMoth = 95;
    static OffsetIconLadybug = 96;
    static OffsetIconWorker = 97;
    static OffsetIconQueen = 98;
    static OffsetIconBeehive = 99;
    static OffsetIconDragonfly = 100;
    static OffsetIconPlaque = 108;
    static OffsetIconPlaqueTranslate = 109;
    static OffsetIconPlaqueReflect = 141;
    static OffsetIconPlaqueRotate = 145;
    ...
    static OffsetTemplateGrass = 6;
    static OffsetTemplateWood = 7;
    static OffsetTemplateStone = 8;
    static OffsetTemplateWater = 9;
    static OffsetTemplateCloud = 10;
    static OffsetTemplateFront = 11;
    static OffsetTemplateBack = 12;
    static OffsetTemplateTile = 13;
    static OffsetTemplateBasePlain = 14;
    static OffsetTemplateCrease = 15;
